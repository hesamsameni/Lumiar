...
export const TOKEN_PACKS = [
  ...
  { id: 'pack_150', tokens: 150, price: 12.99, label: '150 Tokens', badge: 'Popular' },
  { id: 'pack_500', tokens: 500, price: 39.99, label: '500 Tokens', badge: 'Best Value' },
]

export const GENERATION_TAGS = [
  'portrait', 'landscape', 'abstract', 'anime', 'photorealistic',
  'concept art', 'illustration', 'logo', 'architecture', 'nature',
  'fantasy', 'sci-fi', 'vintage', 'minimalist', 'surreal',
  'product', 'food', 'fashion', 'interior', 'dark art',
]
