...
3.  3
    ...
    Now, when you use the OpenAI SDK to call Mistral, PostHog automatically captures `$ai_generation` events via the OpenTelemetry instrumentation.
