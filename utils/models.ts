...
export const AI_MODELS: AIModel[] = [
  // —— OpenAI models (direct API) ——
  {
    ...
    name: "GPT Image 2",
    description:
      "Latest OpenAI model — highest fidelity, up to 4K resolution, excellent for editing",
    tier: "high",
    provider: "openai",
  ...
  },
  {
    ...
    name: "GPT Image 1",
    description:
      "Reliable quality with excellent prompt adherence and image editing",
    tier: "high",
    provider: "openai",
  ...
  },
  {
    ...
    description: "Fast and affordable — great for quick drafts and iteration",
    tier: "low",
    provider: "openai",
  ...
  // —— OpenRouter models ——
  {
    ...
    name: "Recraft V4 Pro",
    description:
      "Highest fidelity — 2K resolution, supports image-to-image editing",
    tier: "high",
    provider: "openrouter",
  ...
  },
  {
    ...
    name: "Recraft V4",
    description:
      "Strong composition and color coherence — great for product and editorial",
    tier: "mid",
    provider: "openrouter",
  ...
  },
  {
    ...
    name: "Flux.2 Pro",
    description:
      "FLUX flagship — photorealistic output with stunning detail and sharpness",
    tier: "high",
    provider: "openrouter",
    tokensPerGeneration: 10,
  ...
  },
  {
    ...
    name: "Flux.2 Flex",
    description:
      "Flexible resolution FLUX — solid quality at variable output sizes",
    tier: "mid",
    provider: "openrouter",
