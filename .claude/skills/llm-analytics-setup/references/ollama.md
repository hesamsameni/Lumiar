...
3.  3
    ...
    Now, when you use the OpenAI SDK to call Ollama, PostHog automatically captures `$ai_generation` events via the OpenTelemetry instrumentation.
